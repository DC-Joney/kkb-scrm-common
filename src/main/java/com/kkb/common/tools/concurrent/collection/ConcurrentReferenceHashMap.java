...
public final class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V>
    ...
    static final class HashEntry<K, V> {
        ...
        final K key() {
            if (keyRef instanceof ConcurrentReferenceHashMap.KeyReference)
        ...
        final V dereferenceValue(Object value) {
            if (value instanceof ConcurrentReferenceHashMap.KeyReference)
    ...
    final class KeyIterator
        ...
        @Override
        public K next() {
            HashEntry<K, V> hashEntry = super.nextEntry();
